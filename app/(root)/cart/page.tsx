...
import { APP_NAME, FREE_SHIPPING_MINIMUM_PRICE } from "@/lib/constants";
      ...
      <div className="grid grid-cols-1 md:grid-cols-4  md:gap-4">
        {items.length === 0 ? (
          <Card className="col-span-4 rounded-none">
            ...
            <CardContent>
              Cart.Continue shopping on <Link href="/">{APP_NAME}</Link>,
            </CardContent>
          </Card>
        ) : (
          <>
                ...
                <CardContent className="py-4 space-y-4">
                  {itemsPrice < FREE_SHIPPING_MINIMUM_PRICE ? (
                    <div className="flex-1">
                      ...
                      Cart.of eligible items to your order to qualify for FREE
                      Shipping
                    </div>
                  ) : (
                    <div className="flex-1">
